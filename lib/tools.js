...
const koi_contract = "SA9GPHp4yf82XjefUIYsyF_LOgRRqIPhjy7NWh-Pw04";
// const bundlerNodes = "http://bundler.openkoi.com:8887";

//const koi_contract = "3yT_LZcWPs8rL6B9uESIl7VQ5HEvBVUPYomEbEdeRBU";
// const koi_contract = "8F-LVZ1AZGLUsh7rW23PmJZ6VMiILSZ3eBN-GlSQJ8Y";
 ...
 */
  ...
  */
  ...
  async contentView(contentTxId) {
    // const state = await this.getContractState();
    const path = "http://bundler.openkoi.com:8887/state/current/";
   ...
   */
  async getTopContent() {
    const path = "http://bundler.openkoi.com:8887/state/getTopContent/";
