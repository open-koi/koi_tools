...
*/
  ...
  //  const response = await smartweave.interactWriteDryRun(
  //     arweave,
  //     wallet,
  //     koi_contract,
  //     input,   
    ...
    return new Promise(function (resolve, reject) {
      smartweave
        ...
        .then(async (txId) => {
            ...
            await recalculatePredictedState(wallet)
...
module.exports = koi;
  /*
   ...
   Returns the a promise
 */
  async function recalculatePredictedState(wallet){
    // get leteststate
    ...
    for(let i=0;i<pendingStateArray.length;i++){
      console.log("ZZZZZ",pendingStateArray[i],pendingStateArray[i].input)
      if(i==0){
